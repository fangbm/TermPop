...
$filter = @(
  ...
  "[4:a]highpass=f=1800,lowpass=f=7000,volume=5.0,afade=t=out:st=0.012:d=0.043,adelay=20220|20220[p3]",
  "[5:a]highpass=f=1800,lowpass=f=7000,volume=5.0,afade=t=out:st=0.012:d=0.043,adelay=22100|22100[p4]",
