param(
  [string]$OutputPath = "artifacts/termpop-promo-en-v1-16x9.mp4",
...
$renderer = Join-Path $PSScriptRoot "render-termpop-promo-en-v1.mjs"
$framesDir = Join-Path $repoRoot "artifacts\promo-en-v1-frames"
...
$renderInfo = [ordered]@{
  source = "scripts/termpop-promo-en-v1.html"
