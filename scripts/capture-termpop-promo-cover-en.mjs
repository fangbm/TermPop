...
const source = path.resolve(import.meta.dirname, "termpop-promo-cover-en.html");
...
await page.screenshot({ path: path.join(output, "termpop-promo-cover-en-1920x1080.png") });
await page.screenshot({
  path: path.join(output, "termpop-promo-cover-en-1920x1080.jpg"),
  type: "jpeg",
  quality: 95,
});
...
await page.screenshot({ path: path.join(output, "termpop-promo-cover-en-1280x720.png") });
...
await page4x3.screenshot({ path: path.join(output, "termpop-promo-cover-en-1600x1200.png") });
await page4x3.screenshot({
  path: path.join(output, "termpop-promo-cover-en-1600x1200.jpg"),
  type: "jpeg",
  quality: 95,
});
