...
const source = path.resolve(import.meta.dirname, "termpop-promo-v4-60s.html");
const output = path.resolve(root, process.env.TERMPOP_STILLS_DIR || "artifacts/promo-v4-60s-stills");
